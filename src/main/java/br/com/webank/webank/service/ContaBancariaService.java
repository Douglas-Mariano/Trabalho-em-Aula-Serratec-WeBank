...
public class ContaBancariaService {
    ...
    public List<ContaBancariaResponseDTO> obterTodos(){
        ...
        for (ContaBancaria conta :  listaContaBancaria) {
            ...
            listaResponse.add(mapper.map(conta, ContaBancariaResponseDTO.class));
        }
    ...
    public ContaBancariaResponseDTO obterPorId(long id){
        ...
        ContaBancariaResponseDTO contaBancariaResponse = mapper.map(optContaBancaria.get(), ContaBancariaResponseDTO.class);
